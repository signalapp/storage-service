...
public class GroupsControllerTest extends BaseGroupsControllerTest {
  ...
  public void testAcceptMemberPendingPniAciProfileKeyInvitation() throws Exception {
    ...
    assertThat(signedChange).isEqualTo(changeCaptor.getValue());
    assertThat(signedChange.getChangeEpoch()).isEqualTo(4);
    assertThat(Actions.parseFrom(signedChange.getActions()).getVersion()).isEqualTo(1);
    assertThat(Actions.parseFrom(signedChange.getActions()).getSourceUuid()).isEqualTo(ByteString.copyFrom(validUserTwoPniPresentation.getAciCiphertext().serialize()));
