...
/**
 * This class attempts to supply a meaningful host string for use in logging attribution. It prioritizes the hostname
 * value via {@link InetAddress#getHostName()}, but falls back to:
 * <ul>
 ...
 */
public class LoggingHostSupplier {
